...
// === Hive Processing ===
export const NECTAR_TO_HONEY_RATIO = 1 / 2;
export const PROCESSING_RATE = 1 / 50; // nectar consumed per tick when processing
...
// === Bee Energy ===
export const ENERGY_DRAIN_FLYING = 2 / 1000;
export const ENERGY_DRAIN_WORKING = 1 / 1000;
export const ENERGY_DRAIN_IDLE = 1 / 10000;
export const ENERGY_HUNGER_THRESHOLD = 3 / 10;
...
// === Waystation ===
export const WAYSTATION_NECTAR_CAPACITY = 3 / 2;
export const WAYSTATION_POLLEN_CAPACITY = 1;

// === Hauler ===
export const HAULER_CARRY_CAPACITY = 2 / 5;
export const HAULER_PICKUP_TICKS = 5;

// === Pheromones ===
export const PHEROMONE_PAINT_AMOUNT = 3 / 10;
export const PHEROMONE_MAX = 1;
export const PHEROMONE_DECAY_RATE = 1 / 1000; // per tick
